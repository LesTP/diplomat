...
Date: 2026-06-27 | Status: Open (Phase 49) | Priority: Important
...
Revisit if: a future narrative needs a deliberately structured two-pane layout; if so, balance must still be preserved (no empty column) and the regression test updated accordingly.
