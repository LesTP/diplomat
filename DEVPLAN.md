...
- **Operator-supervised work in flight (2026-06-21):** Phase 42 Commits 1-4 done; Commit 5 (I-axis convergence) pending. See `PHASE_42_PLAN.md` "Cold Start" section at top — single doc has everything to resume. Phase 3 (scale probe) data committed at `scenarios/scale_probe_*`. Phase 4 docs (`ARCH_scenario_authoring.md`, `SCENARIO_GUIDE.md`) shipped.
