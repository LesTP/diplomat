...
- **Phase** — Phase 10: Adversarial, planned and ready to execute.
- **Focus** — Optional LLM-based draft critique against `ARCH_adversarial.md`.
- **Blocked/Broken** — none.
